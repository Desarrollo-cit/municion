...
const guardarhelado = async (evento) => {
    ...
    try {
        ...
        const url = '/municion/API/helado/guardar'
...
const buscarhelado = async (evento) => {
    ...
    try {
        const url = '/municion/API/helado/buscar'
        const headers = new Headers();
        headers.append("X-requested-With", "fetch");
...
const modificarhelado = async (evento) => {
    ...
    try {
        //Crear el cuerpo de la consulta
        const url = '/municion/API/helado/modificar'
        const body = new FormData(formhelado);
        const headers = new Headers();
        headers.append("X-requested-With", "fetch");
...
window.eliminarRegistro = (id) => {
    Swal.fire({
        ...
        if(result.isConfirmed){
            const url = '/municion/API/helado/eliminar'
