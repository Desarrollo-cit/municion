...
const guardarCalibre = async (evento) => {
    ...
    try {
        ...
        const url = '/municion/API/Calibre/guardar'
...
const buscarCalibre = async (evento) => {
    ...
    try {
        const url = '/municion/API/Calibre/buscar'
        const headers = new Headers();
        headers.append("X-requested-With", "fetch");
...
const modificarCalibre = async (evento) => {
    ...
    try {
        //Crear el cuerpo de la consulta
        const url = '/municion/API/Calibre/modificar'
        const body = new FormData(formCalibre);
        const headers = new Headers();
        headers.append("X-requested-With", "fetch");
...
window.eliminarRegistro = (id) => {
    Swal.fire({
        ...
        if(result.isConfirmed){
            const url = '/municion/API/Calibre/eliminar'
