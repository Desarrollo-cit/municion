...
const guardarSituaciones = async (evento) => {
    ...
    try {
        ...
        const url = '/municion/API/Situaciones/guardar'
...
const buscarSituaciones = async (evento) => {
    ...
    try {
        const url = '/municion/API/Situaciones/buscar'
        const headers = new Headers();
        headers.append("X-requested-With", "fetch");
...
const modificarSituaciones = async (evento) => {
    ...
    try {
        //Crear el cuerpo de la consulta
        const url = '/municion/API/Situaciones/modificar'
        const body = new FormData(formSituaciones);
        const headers = new Headers();
        headers.append("X-requested-With", "fetch");
...
window.eliminarRegistro = (id) => {
    Swal.fire({
        ...
        if(result.isConfirmed){
            const url = '/municion/API/Situaciones/eliminar'
