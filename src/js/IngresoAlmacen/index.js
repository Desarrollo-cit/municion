...
const guardarIngresoAlmacen = async (evento) => {
  ...
  try {
    ...
    const url = "/municion/API/IngresoAlmacen/guardar";
...
const buscarIngresoAlmacen = async (e) => {
  ...
  try {
    const url = "/municion/API/IngresoAlmacen/buscar";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarIngresoAlmacen1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoAlmacen/buscaringreso";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarSalidaFab1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoAlmacen/buscarSalida";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarRechazoAlmacen = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoAlmacen/buscarRechazo";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const HistorialFabrica = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoAlmacen/historialFabrica";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarComando = async (e) => {
  ...
  try {
    const url = `/municion/API/IngresoAlmacen/comando?valor=${valor}`;
...
window.eliminarRegistro = async (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const url = "/municion/API/IngresoAlmacen/eliminar";
...
window.validarRegistro = (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      const url = "/municion/API/IngresoAlmacen/validarRegistro";
      const body = new FormData();
      body.append("id", id);
      const headers = new Headers();
      headers.append("X-requested-With", "fetch");
...
window.GenerarSalida = async (id) => {
  ...
  const url = `/municion/API/IngresoAlmacen/GenerarSalida`;
  const body = new FormData();
  body.append("id", id);
  const headers = new Headers();
  headers.append("X-Requested-With", "fetch");
...
window.GenerarRegreso = async (id) => {
  ...
  const url = `/municion/API/IngresoAlmacen/GenerarRegreso`;
  const body = new FormData();
  body.append("id", id);
  const headers = new Headers();
  headers.append("X-Requested-With", "fetch");
...
const guardarTraslado = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoAlmacen/guardarTraslado";
...
const generarTraslado = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoAlmacen/generarTraslado";
...
const guardarRegreso = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoAlmacen/guardarRegreso";
...
const buscarCatalogo = async (e) => {
  ...
  try {
    const url = `/municion/API/IngresoAlmacen/catalogo?catalogo=${catalogo}`;
    const config = { method: "GET" };
...
const buscarCatalogoTraslado = async (e) => {
  ...
  try {
    const url = `/municion/API/IngresoAlmacen/catalogosalida?catalogosalida=${catalogosalida}`;
    const config = { method: "GET" };
    const response = await fetch(url, config);
...
window.GenerarSalidaMunicionDestinada = async (id) => {
  ...
  const url = `/municion/API/IngresoAlmacen/GenerarSalidaMunicionDestinada`;
  const body = new FormData();
  body.append("id", id);
  const headers = new Headers();
  headers.append("X-Requested-With", "fetch");
