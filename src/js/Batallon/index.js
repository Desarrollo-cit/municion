...
const buscarBatallon = async (e) => {
  ...
  try {
    const url = "/municion/API/Batallon/buscar";
...
const buscarCompaniaTabla = async (e) => {
  ...
  try {
    const url = "/municion/API/Batallon/CompaniaTabla";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarPelotonTabla = async (e) => {
  ...
  try {
    const url = "/municion/API/Batallon/PelotonTabla";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarBatallon1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/Batallon/buscaringreso";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarBatallonAsignado = async (evento) => {
  ...
  try {
    const url = "/municion/API/Batallon/buscaringresoAsignado";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarSalidaFab1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/Batallon/buscarSalida";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarRechazoAlmacen = async (evento) => {
  ...
  try {
    const url = "/municion/API/Batallon/buscarRechazo";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const HistorialFabrica = async (evento) => {
  ...
  try {
    const url = "/municion/API/Batallon/historialFabrica";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
window.eliminarRegistro = async (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const url = "/municion/API/Batallon/eliminar";
...
window.validarRegistro = (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const url = "/municion/API/Batallon/validarRegistro";
      const body = new FormData();
      body.append("id", id);
      const headers = new Headers();
      headers.append("X-requested-With", "fetch");
...
window.GenerarSalida = async (id) => {
  ...
  const url = `/municion/API/Batallon/GenerarSalida`;
  const body = new FormData();
  body.append("id", id);
  const headers = new Headers();
  headers.append("X-Requested-With", "fetch");
  ...
  const url1 = `/municion/API/Batallon/buscarCompania?batallon1=${batallon1}&comando1=${comando1}`;
...
//  return;
  ...
  let batallon1 = info[0].batallon;
  let comando1 = info[0].departamento;
  const url1 = `/municion/API/Batallon/buscarCompaniaSalida?batallon1=${batallon1}&comando1=${comando1}`;
...
const guardarTraslado = async (evento) => {
  ...
  try {
    const url = "/municion/API/Batallon/guardarTraslado";
...
const guardarRegreso = async (evento) => {
  ...
  try {
    const url = "/municion/API/Batallon/guardarTrasladoRegreso";
...
const guardarRegresoComando = async (evento) => {
  ...
  try {
    const url = "/municion/API/Batallon/guardarTrasladoRegresoComando";
...
const catalogoTraslado1 = async (e) => {
  ...
  try {
    const url = `/municion/API/Batallon/catalogo?catalogo=${catalogo}`;
...
const buscarSinoptico = async (e) => {
  ...
  try {
    const url = "/municion/API/Batallon/buscarSinoptico";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
