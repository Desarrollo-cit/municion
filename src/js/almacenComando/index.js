...
const buscaralmacenComando = async (e) => {
  ...
  try {
    const url = "/municion/API/almacenComando/buscar";
...
const buscaralmacenComando1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/almacenComando/buscaringreso";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscaralmacenComandoAsignado = async (evento) => {
  ...
  try {
    const url = "/municion/API/almacenComando/buscaringresoAsignado";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarSalidaFab1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/almacenComando/buscarSalida";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarRechazoAlmacen = async (evento) => {
  ...
  try {
    const url = "/municion/API/almacenComando/buscarRechazo";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const HistorialFabrica = async (evento) => {
  ...
  try {
    const url = "/municion/API/almacenComando/historialFabrica";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
window.eliminarRegistro = async (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const url = "/municion/API/almacenComando/eliminar";
...
window.validarRegistro = (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const url = "/municion/API/almacenComando/validarRegistro";
      const body = new FormData();
      body.append("id", id);
      const headers = new Headers();
      headers.append("X-requested-With", "fetch");
...
window.GenerarSalida = async (id) => {
  // console.log(tipo1)
  // alert(id);
  const url = `/municion/API/almacenComando/GenerarSalida`;
  const body = new FormData();
  body.append("id", id);
  const headers = new Headers();
  headers.append("X-Requested-With", "fetch");
...
window.GenerarRegreso = async (id) => {
  ...
  const url = `/municion/API/almacenComando/GenerarRegreso`;
  const body = new FormData();
  body.append("id", id);
  const headers = new Headers();
  headers.append("X-Requested-With", "fetch");
...
const guardarTraslado = async (evento) => {
  ...
  try {
    const url = "/municion/API/almacenComando/guardarTraslado";
...
const guardarRegreso = async (evento) => {
  ...
  try {
    const url = "/municion/API/almacenComando/guardarRegreso";
...
const catalogoTraslado1 = async (e) => {
  ...
  try {
    const url = `/municion/API/almacenComando/catalogo?catalogo=${catalogo}`;
