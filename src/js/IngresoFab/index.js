...
const guardarIngresoFab = async (evento) => {
  ...
  try {
    ...
    const url = "/municion/API/IngresoFab/guardar";
...
const buscarIngresoFab = async (e) => {
  ...
  try {
    const url = "/municion/API/IngresoFab/buscar";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarIngresoFab1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoFab/buscaringreso";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarSalidaFab1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoFab/buscarSalida";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const HistorialFabrica = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoFab/historialFabrica";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
const buscarRechazoAlmacen1 = async (evento) => {
  ...
  try {
    const url = "/municion/API/IngresoFab/buscarRechazo";
    const headers = new Headers();
    headers.append("X-requested-With", "fetch");
...
window.eliminarRegistro = async (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const url = "/municion/API/IngresoFab/eliminar";
...
window.validarRegistro = (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const url = "/municion/API/IngresoFab/validarRegistro";
      const body = new FormData();
      body.append("id", id);
      const headers = new Headers();
      headers.append("X-requested-With", "fetch");
...
window.GenerarSalida = async (id) => {
  ...
  const url = `/municion/API/IngresoFab/GenerarSalida`;
  const body = new FormData();
  body.append("id", id);
  const headers = new Headers();
  headers.append("X-Requested-With", "fetch");
...
const guardarTraslado = async (evento) => {
  ...
  GenerarSalida1.hide();
  try {
    const url = "/municion/API/IngresoFab/guardarTraslado";
...
const buscarCatalogo = async () => {
  ...
  try {
    const url = `/municion/API/IngresoFab/catalogo?catalogo=${catalogo}`;
