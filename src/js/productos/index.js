...
const guardarProducto = async (evento) => {
    ...
    try {
        ...
        const url = '/municion/API/productos/guardar'
...
const buscarProducto = async (evento) => {
    ...
    try {
        const url = '/municion/API/productos/buscar'
        const headers = new Headers();
        headers.append("X-requested-With", "fetch");
...
const modificarProducto = async (evento) => {
    ...
    try {
        //Crear el cuerpo de la consulta
        const url = '/municion/API/productos/modificar'
        const body = new FormData(formProductos);
        const headers = new Headers();
        headers.append("X-requested-With", "fetch");
...
window.eliminarRegistro = (id) => {
    Swal.fire({
        ...
        if(result.isConfirmed){
            const url = '/municion/API/productos/eliminar'
